...
public class ModelLogisticArm extends EntityModel<EntityLogisticArm>
{
    private RendererModel mainPedestal;
    private RendererModel secondPedestal;

    private RendererModel bodyPiston1;
    private RendererModel bodyPiston2;

    private RendererModel piston1;
    private RendererModel piston2;

    private RendererModel rodPiston1;
    private RendererModel rodPiston2;

    private RendererModel mainSupportPliers;

    private RendererModel headPiston1;
    private RendererModel headPiston2;

    private RendererModel mainPliers;
    private RendererModel topPhalanxPliers1;
    private RendererModel bottomPhalanxPliers1;
    private RendererModel topPhalanxPliers2;
    private RendererModel bottomPhlanxPliers2;

    private RendererModel secondSupportPliers1;
    private RendererModel secondSupportPliers2;

    public ModelLogisticArm()
    {
        mainPedestal = new RendererModel(this, 20, 11);
        mainPedestal.setTextureSize(64, 32);
        mainPedestal.addBox(-5.5F, -2F, -5.5F, 11, 4, 11);
        mainPedestal.setRotationPoint(8F, -6F, 0F);
        secondPedestal = new RendererModel(this, 28, 0);
        secondPedestal.setTextureSize(64, 32);
        secondPedestal.addBox(-4.5F, -1F, -4.5F, 9, 2, 9);
        secondPedestal.setRotationPoint(8F, -3F, 0F);
        bodyPiston1 = new RendererModel(this, 0, 0);
        bodyPiston1.setTextureSize(64, 32);
        bodyPiston1.addBox(-1.5F, -8F, -1.5F, 3, 16, 3);
        bodyPiston1.setRotationPoint(5.5F, 6F, 0F);
        bodyPiston2 = new RendererModel(this, 0, 0);
        bodyPiston2.setTextureSize(64, 32);
        bodyPiston2.addBox(-1.5F, -8F, -1.5F, 3, 16, 3);
        bodyPiston2.setRotationPoint(10.5F, 6F, 0F);
        piston1 = new RendererModel(this, 12, 0);
        piston1.setTextureSize(64, 32);
        piston1.addBox(-1F, -10F, -1F, 2, 20, 2);
        piston1.setRotationPoint(5.5F, 4.5F, 0F);
        piston2 = new RendererModel(this, 12, 0);
        piston2.setTextureSize(64, 32);
        piston2.addBox(-1F, -10F, -1F, 2, 20, 2);
        piston2.setRotationPoint(10.5F, 4.5F, 0F);
        rodPiston1 = new RendererModel(this, 20, 0);
        rodPiston1.setTextureSize(64, 32);
        rodPiston1.addBox(-0.5F, -10.5F, -0.5F, 1, 21, 1);
        rodPiston1.setRotationPoint(5.5F, 4.5F, 0F);
        rodPiston2 = new RendererModel(this, 20, 0);
        rodPiston2.setTextureSize(64, 32);
        rodPiston2.addBox(-0.5F, -10.5F, -0.5F, 1, 21, 1);
        rodPiston2.setRotationPoint(10.5F, 4.5F, 0F);
        mainSupportPliers = new RendererModel(this, 0, 25);
        ...
        bottomPhalanxPliers1 = new RendererModel(this, 14, 22);
        ...
        topPhalanxPliers2 = new RendererModel(this, 0, 20);
        ...
        bottomPhlanxPliers2 = new RendererModel(this, 14, 22);
        ...
        secondSupportPliers1 = new RendererModel(this, 50, 27);
        ...
        secondSupportPliers2 = new RendererModel(this, 50, 27);
